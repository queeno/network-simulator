...
public class RunMode {
	...
	private static boolean terminate_simulation = false;
	...
	public static boolean singleRun(boolean v, int runNum) {
		...
		while((m_runSampleCount < Config.numSamples() || Config.runForever()) && !terminate_simulation) {
	...
	public static void setTerminateSimulation (boolean terminate){ terminate_simulation = true; }
	
	public  static int sampleNum() { return m_runSampleCount; }
	public 	static boolean getTerminateSimulation() { return terminate_simulation; }
